...
# Asrofil
- **AGENDA**
	- [Daily](obsidian://advanced-uri?vault=Asrofil%20Vault&daily=true)
	- [Weekly](obsidian://advanced-uri?vault=Asrofil%20Vault&commandid=calendar%253Aopen-weekly-note)
	- [[Main Dash|Task Dashboard]]
- **LIFE**
	- [[Personal|Personal]]
	- [[Home|Home]]
	- [[Files|Files]]
...
for (const file of files) {
  ...
  const nextBirthday = new Date(year + birthday.slice(4));
...
return (
  <div className="musicBirthday">
    <div style={{ flex: 1, textAlign: "center" }}>
      ...
      <p style={{ fontSize: "0.85em", opacity: 0.7 }}>Tambah embed playlist di sini</p>
    </div>
    <div style={{ flex: 1, textAlign: "center" }}>
      <p><b>UPCOMING BIRTHDAYS</b></p>
      <p>{count} dalam 30 hari:<br />{cells}</p>
    </div>
  </div>
);
```
...
FROM "Work" OR "Coding" OR "Personal"
